...
local jwt_decoder = require "kong.plugins.advokit-jwt.jwt_parser"
...
function JwtHandler:access(conf)
  ...
  ngx.log(ngx.STDERR, inspect(claims))

  ngx.req.set_header("X-Advokit-Account", claims['acc'])
  ngx.req.set_header("X-Advokit-Admin", tostring(claims['adm']))
  ngx.req.set_header("X-Advokit-SuperAdmin", tostring(claims['adm'] and claims['acc'] == "superpixel"))
  ngx.req.set_header("X-Advokit-User", claims['sub'])
  ngx.req.set_header("X-Advokit-Test", tostring(claims['test']))
